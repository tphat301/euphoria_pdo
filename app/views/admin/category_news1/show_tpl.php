...
<div class="content-wrapper" style="min-height: 378px;">
    ...
    <div class="container-fluid">
      <div class="row">
        <ol class="breadcrumb float-sm-left">
          ...
          <li class="breadcrumb-item active">Quản lý <?= $configAdmin['category_news1']['name'] ?></li>
        </ol>
      </div>
    </div>
  </section>
  ...
  <section class="content">
    <form class="validation-form" method="POST" action="<?= $configBase['baseUrl'] . "admin/category_news1/stored?id=" . $catNewsDetail['id'] ?>" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col-xl-8">
          ...
          <!-- Slug -->
          <?php if (isset($configAdmin['category_news1']['slug']) && $configAdmin['category_news1']['slug'] === true) { ?>
          ...
          <div class="card card-primary card-outline text-sm">
            <div class="card-header">
              <h3 class="card-title">Nội dung <?= $configAdmin['category_news1']['name'] ?></h3>
                ...
                <div class="card-body card-article">
                  <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                    <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang">
                      ...
                      <?php if (isset($configAdmin['category_news1']['title']) && $configAdmin['category_news1']['title'] === true) { ?>
                      ...
                      <?php if (isset($configAdmin['category_news1']['desc']) && $configAdmin['category_news1']['desc'] === true) { ?>
                        <div class="form-group">
                          <label for="desc">Mô tả:</label>
                          <textarea class="<?= $configAdmin['category_news1']['desc_tiny'] === true ? 'tiny' : '' ?> form-control text-sm form-control-ckeditor" name="description" id="desc" rows="5" placeholder="Mô tả"><?= isset($catNewsDetail['description']) ? htmlspecialchars_decode($catNewsDetail['description']) : "" ?></textarea>
                        </div>
                      <?php } ?>

                      <?php if (isset($configAdmin['category_news1']['content']) && $configAdmin['category_news1']['content'] === true) { ?>
                        <div class="form-group">
                          <label for="content">Nội dung:</label>
                          <textarea class="<?= $configAdmin['category_news1']['content_tiny'] === true ? 'tiny' : '' ?> form-control text-sm form-control-ckeditor" name="content" id="content" rows="5" placeholder="Nội dung"><?= isset($catNewsDetail['content']) ? htmlspecialchars_decode($catNewsDetail['content']) : "" ?></textarea>
                        </div>
                      <?php } ?>
                    </div>
                  </div>
        ...
        <div class="col-xl-4">
          ...
          <div class="card card-primary card-outline text-sm">
            <div class="card-header">
              <h3 class="card-title">Thông tin <?= $configAdmin['category_news1']['name'] ?></h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
              </div>
            </div>
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                $statusConfig = $configAdmin['category_news1']['status'];
                $statusTitleConfig = $configAdmin['category_news1']['status_title'];
              ...
              <!-- STT -->
              <?php if (isset($configAdmin['category_news1']['num']) && $configAdmin['category_news1']['num'] === true) { ?>
                <div class="form-group">
          ...
          <!-- Photo 1 -->
          <?php if (isset($configAdmin['category_news1']['photo1']) && $configAdmin['category_news1']['photo1'] === true) { ?>
            <div class="card card-primary card-outline text-sm">
              <div class="card-header">
              ...
              <div class="card-body">
                <div class="photoUpload-zone">
                  <div class="photoUpload-detail" id="photoUpload-preview">
                    <img class="rounded" src="<?= isset($catNewsDetail['photo1']) && !empty($catNewsDetail['photo1']) ? $configBase['baseUrl'] . "upload/category_news1/" .  $catNewsDetail['photo1'] : $configBase['baseUrl'] . 'public/images/noimage.png' ?>" alt=" Alt Photo" />
                    <div class="delete-photo">
                      <a href="javascript:void(0)" id="delete-photo" title="Xóa hình ảnh" data-url="<?= $configBase['baseUrl'] . "admin/category_news1/delete_photo?id=" . $catNewsDetail['id'] . "&photo1=" . $catNewsDetail['photo1'] ?>"><i class="far fa-trash-alt"></i></a>
                    </div>
                  </div>
                  ...
                  <div class="photoUpload-dimension">
                    <?= $configAdmin['category_news1']['upload_rules1'] ?>
                  </div>
                </div>
              </div>
            </div>
          ...
          <!-- Photo 2 -->
          <?php if (isset($configAdmin['category_news1']['photo2']) && $configAdmin['category_news1']['photo2'] === true) { ?>
            <div class="card card-primary card-outline text-sm">
              <div class="card-header">
              ...
              <div class="card-body">
                <div class="photoUpload-zone">
                  <div class="photoUpload-detail" id="photoUpload-preview2">
                    <img class="rounded" src="<?= isset($catNewsDetail['photo2']) && !empty($catNewsDetail['photo2']) ? $configBase['baseUrl'] . "upload/category_news1/" .  $catNewsDetail['photo2'] : $configBase['baseUrl'] . 'public/images/noimage.png' ?>" alt=" Alt Photo" />
                    <div class="delete-photo">
                      <a href="javascript:void(0)" id="delete-photo" title="Xóa hình ảnh" data-url="<?= $configBase['baseUrl'] . "admin/category_news1/delete_photo?id=" . $catNewsDetail['id'] . "&photo2=" . $catNewsDetail['photo2'] ?>"><i class="far fa-trash-alt"></i></a>
                    </div>
                  </div>
                  ...
                  <div class="photoUpload-dimension">
                    <?= $configAdmin['category_news1']['upload_rules2'] ?>
                  </div>
                </div>
              </div>
            </div>
          ...
          <!-- Photo 3 -->
          <?php if (isset($configAdmin['category_news1']['photo3']) && $configAdmin['category_news1']['photo3'] === true) { ?>
            <div class="card card-primary card-outline text-sm">
              <div class="card-header">
              ...
              <div class="card-body">
                <div class="photoUpload-zone">
                  <div class="photoUpload-detail" id="photoUpload-preview3">
                    <img class="rounded" src="<?= isset($catNewsDetail['photo3']) && !empty($catNewsDetail['photo3']) ? $configBase['baseUrl'] . "upload/category_news1/" .  $catNewsDetail['photo3'] : $configBase['baseUrl'] . 'public/images/noimage.png' ?>" alt=" Alt Photo" />
                    <div class="delete-photo">
                      <a href="javascript:void(0)" id="delete-photo" title="Xóa hình ảnh" data-url="<?= $configBase['baseUrl'] . "admin/category_news1/delete_photo?id=" . $catNewsDetail['id'] . "&photo3=" . $catNewsDetail['photo3'] ?>"><i class="far fa-trash-alt"></i></a>
                    </div>
                  </div>
                  ...
                  <div class="photoUpload-dimension">
                    <?= $configAdmin['category_news1']['upload_rules3'] ?>
                  </div>
                </div>
              </div>
            </div>
          ...
          <!-- Photo 4 -->
          <?php if (isset($configAdmin['category_news1']['photo4']) && $configAdmin['category_news1']['photo4'] === true) { ?>
            <div class="card card-primary card-outline text-sm">
              <div class="card-header">
              ...
              <div class="card-body">
                <div class="photoUpload-zone">
                  <div class="photoUpload-detail" id="photoUpload-preview4">
                    <img class="rounded" src="<?= isset($catNewsDetail['photo4']) && !empty($catNewsDetail['photo4']) ? $configBase['baseUrl'] . "upload/category_news1/" .  $catNewsDetail['photo4'] : $configBase['baseUrl'] . 'public/images/noimage.png' ?>" alt=" Alt Photo" />
                    <div class="delete-photo">
                      <a href="javascript:void(0)" id="delete-photo" title="Xóa hình ảnh" data-url="<?= $configBase['baseUrl'] . "admin/category_news1/delete_photo?id=" . $catNewsDetail['id'] . "&photo4=" . $catNewsDetail['photo4'] ?>"><i class="far fa-trash-alt"></i></a>
                    </div>
                  </div>
                  ...
                  <div class="photoUpload-dimension">
                    <?= $configAdmin['category_news1']['upload_rules4'] ?>
                  </div>
                </div>
              </div>
            </div>
      ...
      <!-- SEO -->
      <?php if (isset($configAdmin['category_news1']['seo']) && $configAdmin['category_news1']['seo'] === true) { ?>
        <div class="card card-primary card-outline text-sm">
          <div class="card-header">
