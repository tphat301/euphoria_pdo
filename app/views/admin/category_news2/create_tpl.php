...
<div class="content-wrapper" style="min-height: 378px;">
    ...
    <div class="container-fluid">
      <div class="row">
        <ol class="breadcrumb float-sm-left">
          ...
          <li class="breadcrumb-item active">Thêm <?= $configAdmin['category_news2']['name'] ?></li>
        </ol>
      </div>
    </div>
  </section>
  ...
  <section class="content">
    <form class="validation-form" method="POST" action="<?= $configBase['baseUrl'] . "admin/category_news2/stored" ?>" enctype="multipart/form-data">
      ...
      <div class="row">
                    ...
                    <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang">
                      ...
                      <?php if (isset($configAdmin['category_news2']['desc']) && $configAdmin['category_news2']['desc'] === true) { ?>
                        <div class="form-group">
                          ...
                          <textarea class="<?= $configAdmin['category_news2']['desc_tiny'] === true ? 'tiny' : '' ?> form-control text-sm form-control-ckeditor" name="description" id="desc" rows="5" placeholder="Mô tả"></textarea>
                        </div>
                      <?php } ?>
                      ...
                      <?php if (isset($configAdmin['category_news2']['content']) && $configAdmin['category_news2']['content'] === true) { ?>
                        <div class="form-group">
                          ...
                          <textarea class="<?= $configAdmin['category_news2']['content_tiny'] === true ? 'tiny' : '' ?> form-control text-sm form-control-ckeditor" name="content" id="content" rows="5" placeholder="Nội dung"></textarea>
                        </div>
                      <?php } ?>
                    </div>
                  </div>
        ...
        <div class="col-xl-4">
          ...
          <!-- Category -->
          <?php if (isset($configAdmin['news']['toggle_category']) && $configAdmin['news']['toggle_category'] === true && count($categoryNews1) > 0) { ?>
            <div class="card card-primary card-outline text-sm">
              <div class="card-header">
                ...
                <div class="form-group-category row">
                  <?php if (isset($configAdmin['news']['category_news1']) && $configAdmin['news']['category_news1'] === true && count($categoryNews1) > 0) { ?>
                    <div class="form-group col-xl-6 col-sm-4">
                      ...
                      <select id="id_parent1" name="id_parent1" class="form-control select-category select2-hidden-accessible" tabindex="-1" aria-hidden="true">
          ...
          <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
              ...
              <!-- Status  -->
              <?php if (isset($configAdmin['category_news2']['status'])) { ?>
                <div class="form-group">
                  <?php if (isset($configAdmin['category_news2']['status_title'])) {
