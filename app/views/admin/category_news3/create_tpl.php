...
<div class="content-wrapper" style="min-height: 378px;">
    ...
    <div class="container-fluid">
      <div class="row">
        <ol class="breadcrumb float-sm-left">
          ...
          <li class="breadcrumb-item active">Thêm <?= $configAdmin['category_news3']['name'] ?></li>
        </ol>
      </div>
    </div>
  </section>
  ...
  <section class="content">
    <form class="validation-form" method="POST" action="<?= $configBase['baseUrl'] . "admin/category_news3/stored" ?>" enctype="multipart/form-data">
      ...
      <div class="row">
                    ...
                    <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang">
                      ...
                      <?php if (isset($configAdmin['category_news3']['desc']) && $configAdmin['category_news3']['desc'] === true) { ?>
                        <div class="form-group">
                          ...
                          <textarea class="<?= $configAdmin['category_news3']['desc_tiny'] === true ? 'tiny' : '' ?> form-control text-sm form-control-ckeditor" name="description" id="desc" rows="5" placeholder="Mô tả"></textarea>
                        </div>
                      <?php } ?>
                      ...
                      <?php if (isset($configAdmin['category_news3']['content']) && $configAdmin['category_news3']['content'] === true) { ?>
                        <div class="form-group">
                          ...
                          <textarea class="<?= $configAdmin['category_news3']['content_tiny'] === true ? 'tiny' : '' ?> form-control text-sm form-control-ckeditor" name="content" id="content" rows="5" placeholder="Nội dung"></textarea>
                        </div>
                      <?php } ?>
                    </div>
                  </div>
        ...
        <div class="col-xl-4">
          ...
          <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
              <!-- Status  -->
              <?php if (isset($configAdmin['category_news3']['status'])) { ?>
                <div class="form-group">
                  <?php if (isset($configAdmin['category_news3']['status_title'])) {
