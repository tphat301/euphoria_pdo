...
<div class="content-wrapper" style="min-height: 378px;">
    ...
    <div class="container-fluid">
      <div class="row">
        <ol class="breadcrumb float-sm-left">
          ...
          <li class="breadcrumb-item active">Thêm <?= $configAdmin['news']['name'] ?></li>
        </ol>
      </div>
    </div>
  </section>
  ...
  <section class="content">
    <form class="validation-form" method="POST" action="<?= $configBase['baseUrl'] . "admin/news/stored" ?>" enctype="multipart/form-data">
                    ...
                    <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang">
                      ...
                      <?php if (isset($configAdmin['news']['desc']) && $configAdmin['news']['desc'] === true) { ?>
                        <div class="form-group">
                          ...
                          <textarea class="<?= $configAdmin['news']['desc_tiny'] === true ? 'tiny' : '' ?> form-control text-sm form-control-ckeditor" name="description" id="desc" rows="5" placeholder="Mô tả"></textarea>
                        </div>
                      <?php } ?>
                      ...
                      <?php if (isset($configAdmin['news']['content']) && $configAdmin['news']['content'] === true) { ?>
                        <div class="form-group">
                          ...
                          <textarea class="<?= $configAdmin['news']['content_tiny'] === true ? 'tiny' : '' ?> form-control text-sm form-control-ckeditor" name="content" id="content" rows="5" placeholder="Nội dung"></textarea>
                        </div>
                      <?php } ?>
                    </div>
                  </div>
        ...
        <div class="col-xl-4">
              ...
              <div class="card-body">
                <div class="form-group-category row">
                  ...
                  <?php if (isset($configAdmin['news']['category_news2']) && $configAdmin['news']['category_news2'] === true && count($categoryNews2) > 0) { ?>
                    <div class="form-group col-xl-6 col-sm-4">
                      ...
                      <select id="id_parent2" name="id_parent2" class="form-control select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                        <option value="0"><?= $configAdmin['category_news2']['name'] ?></option>
                  ...
                  <?php if (isset($configAdmin['news']['category_news3']) && $configAdmin['news']['category_news3'] === true && count($categoryNews3) > 0) { ?>
                    <div class="form-group col-xl-6 col-sm-4">
                      ...
                      <select id="id_parent3" name="id_parent3" class="form-control select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                        <option value="0"><?= $configAdmin['category_news3']['name'] ?></option>
                  ...
                  <?php if (isset($configAdmin['news']['category_news4']) && $configAdmin['news']['category_news4'] === true && count($categoryNews4) > 0) { ?>
                    <div class="form-group col-xl-6 col-sm-4">
                      <label class="d-block" for="id_parent4"><?= $configAdmin['category_news4']['name'] ?>:</label>
                      <select id="id_parent4" name="id_parent4" class="form-control select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                        <option value="0"><?= $configAdmin['category_news4']['name'] ?></option>
          ...
          <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
              ...
              <!-- Status  -->
              <?php if (isset($configAdmin['news']['status'])) { ?>
                <div class="form-group">
                  <?php if (isset($configAdmin['news']['status_title'])) {
            ...
            <div class="card-seo">
              <div class="card card-primary card-outline card-outline-tabs">
                <div class="card-header p-0 border-bottom-0">
                  <ul class="nav nav-tabs" id="custom-tabs-three-tab-lang" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" id="tabs-lang" data-toggle="pill" role="tab" aria-controls="tabs-seolang-vi" aria-selected="true">SEO</a>
                    </li>
                  </ul>
                </div>
                <div class="card-body">
