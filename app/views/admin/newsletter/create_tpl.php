...
<div class="content-wrapper" style="min-height: 378px;">
    ...
    <div class="container-fluid">
      <div class="row">
        <ol class="breadcrumb float-sm-left">
          ...
          <li class="breadcrumb-item active">Thêm <?= $configAdmin['newsletter']['name'] ?></li>
        </ol>
      </div>
    </div>
  </section>
  ...
  <section class="content">
    <form class="validation-form" method="POST" action="<?= $configBase['baseUrl'] . "admin/newsletter/stored" ?>" enctype="multipart/form-data">
                    ...
                    <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang">
                      ...
                      <?php if (isset($configAdmin['newsletter']['fullname']) && $configAdmin['newsletter']['fullname'] === true) { ?>
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control text-sm" name="fullname" id="fullname" placeholder="Họ tên" required />
                        </div>
                      <?php } ?>
                      ...
                      <?php if (isset($configAdmin['newsletter']['phone']) && $configAdmin['newsletter']['phone'] === true) { ?>
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control text-sm" name="phone" id="phone" placeholder="Số điện thoại" />
                        </div>
                      <?php } ?>
                      ...
                      <?php if (isset($configAdmin['newsletter']['note']) && $configAdmin['newsletter']['note'] === true) { ?>
                        <div class="form-group">
                          ...
                          <textarea class="form-control text-sm" name="note" id="note" rows="5" placeholder="Ghi chú"></textarea>
                        </div>
                      <?php } ?>
                      ...
                      <?php if (isset($configAdmin['newsletter']['subject']) && $configAdmin['newsletter']['subject'] === true) { ?>
                        <div class="form-group">
                          ...
                          <textarea class="form-control text-sm" name="subject" id="subject" rows="5" placeholder="Chủ đề"></textarea>
                        </div>
                      <?php } ?>
                    </div>
                  </div>
